...
<div id="wrapper">
	...
	<div class="body body-s">
			...
			<?php echo form_open('c_item/update')?>
			<div class="sky-form">
			
				<header>Perbarui Data Item</header>
				<div class="input">
				...
				<fieldset>		
					...
					<section>
						...
						<label class="input">
							<i class="icon-append icon-user"></i>
							<input type="text" placeholder="Nama Barang" name="nama_barang" value="<?php echo $nama_barang;?>">
							<b class="tooltip tooltip-bottom-right">Perbarui harga item</b>
						</label>
					</section>
					...
					<section>
						<label>
							<i class="icon-append icon-user"></i>
							<h4>Harga per kg (Rp) :</h4>
						</label>
						<label class="input">
							<i class="icon-append icon-envelope-alt"></i>
							<input type="text" placeholder="Harga per kg (Rp)" name="harga" value="<?php echo $harga_barang?>">
							<b class="tooltip tooltip-bottom-right">Masukkan harga item per kg (Rp)</b>
						</label>
					</section>
				</fieldset>
