...
<div id="wrapper">
	...
	<div class="body body-s">
			...
			<?php echo form_open('c_transaksi/edit_fix')?>
				...
				<fieldset>					
					<section>
						<label class="input">
							...
							<input type="text" required="required" placeholder="Tanggal " name="tanggal" id="inputField" value="<?php echo $row->tanggal;?>">
					...
					<div class="row">
						...
						<?php foreach($item->result() as $row2):?>
						<option value="<?php echo $row2->id?>"><?php echo $row2->nama_barang." -  Rp.".$row2->harga_barang." /kg"?></option>
						<?php endforeach;?>
					...
					<div class="row">
						<section class="col col-6">
							<label class="input">
								<input type="text" required="required" placeholder="Berat (kg)" name="berat" value="<?php echo $row->berat?>">
