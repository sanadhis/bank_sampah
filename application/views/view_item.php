	...
	<div class="grid_12">
                ...
                <!-- Button -->
                    <div class="float-right input-short">
                        <a href="<?php echo base_url().'c_item/add_item'?>" class="button">
                        	<span>Tambah Item Baru <img src="<?php echo base_url().'images/anggota/plus-small.gif'?>" tppabs="http://www.xooom.pl/work/magicadmin/images/plus-small.gif" width="12" height="9" alt="New article" /></span>
                        </a>
						<br></br>
                    </div>
                ...
                <!-- Example table -->
                <div class="module">
                	<h2><span>Daftar Harga Item</span></h2>
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>
                                    ...
                                    <th style="width:30%">Harga per kg</th>
							...
							<?php $no=1;foreach($query->result() as $row):?>
                                <tr>
                                    ...
                                    <td><a href=""><?php echo $row->nama_barang;?></a></td>
                                    <td><?php echo "Rp. ".$row->harga_barang;?></td>
                                    
                                    <td class="align-center">
                                    	
                                        <a href="<?php echo base_url().'c_item/edit/'.$row->id?>"><img src="<?php echo base_url().'images/anggota/pencil.gif'?>" tppabs="http://www.xooom.pl/work/magicadmin/images/tick-circle.gif" width="16" height="16" alt="published" />edit</a>
                                        <a href="<?php echo base_url().'c_item/delete/'.$row->id?>"><img src="<?php echo base_url().'images/anggota/cross-on-white.gif'?>" tppabs="http://www.xooom.pl/work/magicadmin/images/pencil.gif" width="16" height="16" alt="edit" />hapus</a>
                                         </td>
                                </tr>
                               <?php $no++; endforeach;?>
