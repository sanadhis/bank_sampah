...
<div id="wrapper">
	...
	<div class="body body-s">
			...
			<?php echo form_open('c_transaksi/edit_saldo')?>
			<?php foreach($query->result() as $row):?>
			<div class="sky-form">
			
				<header>Edit Saldo Awal</header>
				<div class="input">
				...
				<fieldset>					
					...
					<div class="row">
						<section class="col col-6">
							<label class="input">
								<input type="text" required="required" placeholder="Saldo Awal (Rp)" name="saldo_awal" value="<?php echo $row->saldo?>">
					...
					<section>
						<label class="input">
							...
							<input type="text" placeholder="Tanggal " name="tanggal" id="inputField" value="<?php echo $row->tanggal;?>">
