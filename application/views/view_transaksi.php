...
<div id="wrapper">
	...
	<div class="body body-s">
			...
			<?php echo form_open('c_transaksi/validation')?>
			<div class="sky-form">
			
				<header>Form Transaksi Nasabah</header>
				<div class="input">
				...
				<fieldset>					
					<section>
						<label class="input">
							...
							<input type="text" placeholder="Nomor Registrasi Nasabah" name="id_nasabah" value="<?php if(!empty($_GET)){echo $this->input->get('id_nasabah');}else{echo $this->input->post('id_nasabah');}?>">
					...
					<div class="row">
						...
						<section>
						<select name="item" placeholder="pilih" class="input-short">
						<?php foreach($item->result() as $row):?>
						<option value="<?php echo $row->id?>"><?php echo $row->nama_barang." -  Rp.".$row->harga_barang." /kg"?></option>
						<?php endforeach;?>
					...
					<div class="row">
						<section class="col col-6">
							<label class="input">
								<input type="text" placeholder="Berat (kg)" name="berat" value="<?php echo $this->input->post('berat')?>">
