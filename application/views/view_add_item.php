...
<div id="wrapper">
	...
	<div class="body body-s">
			...
			<?php echo form_open('c_item/validation')?>
			<div class="sky-form">
			
				<header>Tambah Item Baru</header>
				<div class="input">
				...
				<fieldset>					
					<section>
						<label class="input">
							...
							<input type="text" placeholder="Nama Item" name="name" value="<?php echo $this->input->post('name');?>">
							<b class="tooltip tooltip-bottom-right">Masukkan nama item baru</b>
						</label>
					</section>
					...
					<section>
						<label class="input">
							...
							<input type="text" placeholder="Harga per kg (Rp)" name="harga" value="<?php echo $this->input->post('harga')?>">
