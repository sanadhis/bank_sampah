...
<div id="wrapper">
	...
	<b>Konfirmasi Penghapusan Item</b><br>
	<!--<i style="color: #5b5b5b;">"If you think you can, you really can"</i>-->
		...
		<div id=""><h3>Apakah Anda yakin item dengan data berikut akan dihapus?</h3>
		<?php echo form_open('c_item/delete_fix');?>
		
		<input type="hidden" name="id" value="<?php echo $id?>">
		
		
		<table style="border: none;font-size: 12px;color: #5b5b5b;width: 100%;margin: 10px 0 10px 0;">
			<tr><td style="border: none;padding: 4px;">Nama</td><td style="border: none;padding: 4px;"><b><?php echo $nama_barang?></b></td></tr>
			<tr><td style="border: none;padding: 4px;">Harga</td><td style="border: none;padding: 4px;"><b><?php echo $harga_barang?></b></td></tr>
