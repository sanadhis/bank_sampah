...
<div id="wrapper">
	...
	<b>Status :</b><br>
	<i style="color: #5b5b5b;">"SUKSES. Klik <a href="<?php echo base_url().'c_penarikan'?>"><b>di sini</b></a> untuk melakukan penarikan tunai lainnya."</i>
	</div>
	<div class="module">
                    ...
                    <div class="module-table-body">
                       ...
                       <!-- <div class="table-apply">
						...
						<a href="<?php echo base_url().'c_transaksi/topdf'?>" class="button">
