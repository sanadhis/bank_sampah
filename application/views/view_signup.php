...
<div id="wrapper">
	...
	<div class="body body-s">
			...
			<?php echo form_open('c_signup/validation')?>
			<div class="sky-form">
			
				<header>Form Tambah Nasabah Baru</header>
				<div class="input">
				...
				<fieldset>					
					...
					<section>
						<label class="input">
							...
							<input type="text" placeholder="Alamat" name="address" value="<?php echo $this->input->post('address')?>">
					...
					<div class="row">
						<section class="col col-6">
							<label class="input">
								<input type="number" placeholder="RT" name="rt" value="<?php echo $this->input->post('rt')?>">
								<b class="tooltip tooltip-bottom-right">Masukkan RT berapa?</b>
							</label>
						</section>
						<section class="col col-6">
							<label class="input">
								<input type="number" placeholder="RW" name="rw" value="<?php echo $this->input->post('rw')?>">
						...
						<section class="col col-6">
							<label class="input">
								<input type="text" placeholder="BLOK" name="blok" value="<?php echo $this->input->post('blok')?>">
					...
					<section>
						<label class="input">
							...
							<input  type="text" placeholder="Saldo Awal" name="saldo" value="<?php echo $this->input->post('saldo')?>">
							
							<b class="tooltip tooltip-bottom-right">Masukkan saldo awal</b>
						</label>
					</section>
